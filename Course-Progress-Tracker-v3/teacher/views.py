...
from teacher.models import Committee, Deadline, Teacher, Course, User
...
def teacher_home(request):
    ...
    if request.user.is_authenticated:
        ...
        deadlinesCompleted = Deadline.objects.none()
        for course in courses:
            deadlinesCompleted |= Deadline.objects.filter(
